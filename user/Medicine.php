...
<body>
    <div class="container">
        <h1 class="text-warning font-monospace text-center">Medecine</h1>
        <div class="card-container">
            ...
            while ($row = mysqli_fetch_array($Record)) {
                ...
                if ($check_page === 'Medecine') {
                    echo "
                    <form action='insert_cart.php' method='post'>
                        <div class='card' onclick='showProductDetails(\"$row[Pname]\", \"$row[Pprice]\", \"$row[Pimage]\", \"$row[Pdescription]\")'>
