    ...
    <div class="container">
        <div class="confirmation-container">
            ...
            <div class="appointment-details">
                ...
                <p><strong>Amount Paid:</strong> <span class="value">₹<?php echo number_format($appointment['amount_paid'], 2); ?></span></p>
                <p><strong>Status:</strong> <span class="value"><?php echo ucfirst($appointment['status']); ?></span></p>
            </div>

            <div class="d-flex justify-content-between">
                <a href="doctors.php" class="btn btn-custom">Back to Doctors</a>
                <a href="appointments_status.php" class="btn btn-custom">View My Appointments</a>
            </div>
        </div>
    </div>
