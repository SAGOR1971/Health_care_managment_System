...
<body>
    <nav class="navbar navbar-light bg-dark text-white">
        <div class="container-fluid">
            <a href="about.php" class="navbar-brand fw-bold"><img src="user/logo.png" width="90px" alt="logo"></a>
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown pe-3">
                    ...
                    <ul class="dropdown-menu bg-dark" aria-labelledby="doctorsDropdown">
                        ...
                        <li><a class="dropdown-item text-warning" href="user/chat.php">Chat with Doctor AI</a></li>
                    </ul>
                </div>
